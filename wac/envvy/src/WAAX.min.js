...
this._convolver.connect(this._wet);this._dry.connect(this._outputGain);this._wet.connect(this._outputGain);"object"===typeof a&&(this.params=a);this.mix=0.25};
