var WX=WX||{REVISION:1};console.log("Starting WAAX...(REVISION "+WX.REVISION+")");WX._Templates={};WX._Dictionary=Object.freeze({Fader:"Fader.unit",Oscil:"Oscil.unit",Noise:"Noise.unit",LFO:"LFO.unit",Sampler:"Sampler.unit",LPF:"LPF.unit",ADSR:"ADSR.unit",Compressor:"Compressor.unit",FeedbackDelay:"FeedbackDelay.unit",ConVerb:"ConVerb.unit"});WX._context=new webkitAudioContext;WX._customUnitBufferSize=512;WX._customUnitInternals={};
...
set:function(a){this._wet.gain.value=a;this._dry.gain.value=1-a}}});WX._customUnitInternals.DualLevelDetector=function(){Object.defineProperties(this,{_fs:{enumerable:!1,writable:!1,value:WX._context.sampleRate},_attackFast:{enumerable:!1,writable:!0,value:1-Math.exp(-1/(0.125*this._fs))},_releaseFast:{enumerable:!1,writable:!0,value:1-Math.exp(-1/(0.5*this._fs))},_levelFast:{enumerable:!1,writable:!0,value:0},_attackSlow:{enumerable:!1,writable:!0,value:1-Math.exp(-1/(0.25*this._fs))},_releaseSlow:{enumerable:!1,writable:!0,value:1-Math.exp(-1/this._fs)},_levelSlow:{enumerable:!1,
writable:!0,value:0}})};
WX._customUnitInternals.DualLevelDetector.prototype=Object.create(null,{attack:{enumerable:!0,get:function(){return this._attackFast},set:function(a){this._attackFast=1-Math.exp(-1/(a*this._fs))}},release:{enumerable:!0,get:function(){return this._releaseFast},set:function(a){this._releaseFast=1-Math.exp(-1/(a*this._fs))}},reset:{enumerable:!1,value:function(){this._levelSlow=this._levelFast=0}},processLevel:{value:function(a){a=Math.abs(a);this._levelSlow=a>this._levelSlow?this._levelSlow+this._attackSlow*
(a-this._levelSlow):this._levelSlow+this._releaseSlow*(a-this._levelSlow);return this._levelFast=a>this._levelFast?this._levelFast+this._attackFast*(a-this._levelFast):this._levelFast+this._releaseFast*(this._levelSlow-this._levelFast)}}});
WX.C2=function(a){WX._Unit.call(this);Object.defineProperties(this,{_threshold:{enumerable:!1,writable:!0,value:-12},_ratio:{enumerable:!1,writable:!0,value:4},_makeup:{enumerable:!1,writable:!0,value:1},_detector:{enumerable:!1,writable:!1,value:new WX._customUnitInternals.DualLevelDetector},_processor:{enumerable:!1,writable:!1,value:WX._context.createScriptProcessor(WX._customUnitBufferSize,2,2)},_callback:{value:function(a){var b,f=a.inputBuffer.getChannelData(0),g=a.inputBuffer.getChannelData(1),
h=a.outputBuffer.getChannelData(0);a=a.outputBuffer.getChannelData(1);for(var d=0,j=WX._customUnitBufferSize;d<j;++d)b=this._detector.processLevel(Math.max(Math.abs(f[d]),Math.abs(g[d]))),Math.min(0,WX.lin2db(this._threshold/b)),b=WX.db2lin(gainDB),h[d]=f[d]*b*this._makeup,a[d]=g[d]*b*this._makeup}}});var b=this;this._processor.onaudioprocess=function(a){b._callback(a)};this._inlet.connect(this._processor);this._processor.connect(this._outlet);this.params=a};
WX.C2.prototype=Object.create(WX._Unit.prototype,{threshold:{enumerable:!0,get:function(){return this._threshold},set:function(a){this._threshold=a}},ratio:{enumerable:!0,get:function(){return this._ratio},set:function(a){this._ratio=a}},attack:{enumerable:!0,get:function(){return this._detector.attack},set:function(a){this._detector.attack=a}},release:{enumerable:!0,get:function(){return this._detector.release},set:function(a){this._detector.release=a}}});