...
a}},release:{enumerable:!0,get:function(){return this._comp.release.value},set:function(a){this._comp.release.value=a}}});WX.ConVerb=function(a){WX.Unit.Processor.call(this);this.label+="ConVerb";Object.defineProperties(this,{_convolver:{enumerable:!1,writable:!1,value:WX._context.createConvolver()},_dry:{enumerable:!1,writable:!1,value:WX._context.createGain()},_wet:{enumerable:!1,writable:!1,value:WX._context.createGain()},_url:{enumerable:!1,writable:!0,value:"../data/ir/hall.wav"},_defaults:{value:{source:"../data/ir/hall.wav",mix:0.25}}});this._inputGain.connect(this._convolver);this._inputGain.connect(this._dry);
this._convolver.connect(this._wet);this._dry.connect(this._outputGain);this._wet.connect(this._outputGain);this.params=this._defaults;"object"===typeof a&&(this.params=a)};
...
this._target.setValueAtTime(this._params.val,0)}},_controlReleased:{value:function(a){a.preventDefault();window.removeEventListener("mousemove",WX.UIManager.onDragged,!1);window.removeEventListener("mouseup",WX.UIManager.onReleased,!1);WX.UIManager.selected=null;WX.UIManager.onClicked=null;WX.UIManager.onDragged=null;WX.UIManager.onReleased=null}},getValue:function(){return this._params.val},target:{set:function(a){this._target=a},get:function(){return this._target}}});WX.UISliderV=function(a){Object.defineProperties(this,{_container:{value:document.createElement("div")},_placeholder:{value:document.createElement("div")},_control:{value:document.createElement("div")},_label:{value:document.createElement("div")},_rect:{writable:!0,value:null},_pos:{writable:!0,value:{x:0,y:0}},_prev:{writable:!0,value:{x:0,y:0}},_params:{writable:!0,value:{val:a.value||0,offset:a.offset||0,scale:a.scale||1,defaultVal:a.value||0}},_target:{writable:!0,value:null}});this._build(a);
this._rect=this._placeholder.getBoundingClientRect();this._params.val=this._params.defaultVal;this._pos.y=(this._params.val-this._params.offset)/this._params.scale*(this._rect.height-18);this._pos.y=Math.min(this._rect.height-18,Math.max(0,this._pos.x));this._control.style.top=this._pos.y+"px";return this};
...
_controlReleased:{value:function(a){a.preventDefault();window.removeEventListener("mousemove",WX.UIManager.onDragged,!1);window.removeEventListener("mouseup",WX.UIManager.onReleased,!1);WX.UIManager.selected=null;WX.UIManager.onClicked=null;WX.UIManager.onDragged=null;WX.UIManager.onReleased=null}},getValue:function(){return this._params.val},target:{set:function(a){this._target=a},get:function(){return this._target}}});WX.UIKnob=function(a){Object.defineProperties(this,{_container:{value:document.createElement("div")},_placeholder:{value:document.createElement("div")},_control:{value:document.createElement("div")},_label:{value:document.createElement("div")},_rect:{writable:!0,value:null},_angle:{writable:!0,value:0},_prevAngle:{writable:!0,value:0},_params:{writable:!0,value:{val:a.value||0,offset:a.offset||0,scale:a.scale||1,defaultVal:a.value||0}},_target:{writable:!0,value:null}});this._build(a);this._rect=
this._placeholder.getBoundingClientRect();this._params.val=this._params.defaultVal;this._angle=270*((this._params.val-this._params.offset)/this._params.scale)+45;this._angle=Math.min(315,Math.max(45,this._angle));this._control.style.webkitTransform="rotate("+this._angle+"deg)";return this};
...
"rotate("+this._angle+"deg)",this._params.val=(this._angle-45)/270*this._params.scale+this._params.offset,this._label.textContent=this._params.val.toFixed(2),this._prevAngle=a,this._target&&this._target.setValueAtTime(this._params.val,0))}},_handleReleased:{value:function(a){a.preventDefault();window.removeEventListener("mousemove",WX.UIManager.onDragged,!1);window.removeEventListener("mouseup",WX.UIManager.onReleased,!1);WX.UIManager.selected=null;WX.UIManager.onClicked=null;WX.UIManager.onDragged=
null;WX.UIManager.onReleased=null}},getValue:function(){return this._params.val},target:{set:function(a){this._target=a},get:function(){return this._target}}});
