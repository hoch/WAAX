...
updateSize:{value:function(){this._width=this._context.canvas.width;this._height=this._context.canvas.height}},draw:{value:function(){this._pause||(this._analyzer.getByteTimeDomainData(this._buffer),this._drawCallback.call(this,this._buffer,this._context,this._width,this._height))}}});WX.UIManager=Object.create(null,{selected:{writable:!0,value:null},onClicked:{writable:!0,value:null},onDragged:{writable:!0,value:null},onReleased:{writable:!0,value:null}});WX.UISliderH=function(a){Object.defineProperties(this,{_container:{value:document.createElement("div")},_groove:{value:document.createElement("div")},_handle:{value:document.createElement("div")},_label:{value:document.createElement("div")},_rect:{writable:!0,value:null},_pos:{writable:!0,value:{x:0,y:0}},_prev:{writable:!0,value:{x:0,y:0}},_params:{writable:!0,value:{val:a.value||0,offset:a.offset||0,scale:a.scale||1,defaultVal:a.value||0}},_target:{writable:!0,value:null}});this._build(a);this._rect=
this._groove.getBoundingClientRect();this._params.val=this._params.defaultVal;this._pos.x=(this._params.val-this._params.offset)/this._params.scale*(this._rect.width-20);this._pos.x=Math.min(this._rect.width-20,this._pos.x);this._pos.x=Math.max(0,this._pos.x);this._handle.style.left=this._pos.x+"px";return this};
WX.UISliderH.prototype=Object.create(null,{_build:{value:function(a){this._container.appendChild(this._groove);this._container.appendChild(this._label);this._groove.appendChild(this._handle);var b=a.targetDiv;if(void 0===b||null===b)throw console.err("invalid UI panel div"),"error";b.appendChild(this._container);this._container.style.left=a.x+"px";this._container.style.top=a.y+"px";this._container.className="wx-slider-container";this._groove.className="wx-slider-groove wx-slider-bg";this._handle.className=
"wx-slider-handle wx-slider-bg";this._label.className="wx-slider-label";this._label.textContent=a.label;var c=this;this._groove.addEventListener("mousedown",function(a){c._handleClicked.call(c,a)},!1)}},_handleClicked:{value:function(a){a.preventDefault();this._rect=this._groove.getBoundingClientRect();this._prev.x=a.clientX-this._rect.left;var b=this;WX.UIManager.selected=b;WX.UIManager.onDragged=function(a){b._handleDragged.call(b,a)};WX.UIManager.onReleased=function(a){b._handleReleased.call(b,
a)};window.addEventListener("mousemove",WX.UIManager.onDragged,!1);window.addEventListener("mouseup",WX.UIManager.onReleased,!1)}},_handleDragged:{value:function(a){a.preventDefault();a=a.clientX-this._rect.left;this._pos.x+=a-this._prev.x;this._pos.x=Math.min(this._rect.width-20,this._pos.x);this._pos.x=Math.max(0,this._pos.x);this._handle.style.left=this._pos.x+"px";this._prev.x=a;this._params.val=this._pos.x/(this._rect.width-20)*this._params.scale+this._params.offset;this._label.textContent=this._params.val.toFixed(2);
this._target&&this._target.setValueAtTime(this._params.val,0)}},_handleReleased:{value:function(a){a.preventDefault();window.removeEventListener("mousemove",WX.UIManager.onDragged,!1);window.removeEventListener("mouseup",WX.UIManager.onReleased,!1);WX.UIManager.selected=null;WX.UIManager.onClicked=null;WX.UIManager.onDragged=null;WX.UIManager.onReleased=null}},getValue:function(){return this._params.val},target:{set:function(a){this._target=a},get:function(){return this._target}}});
