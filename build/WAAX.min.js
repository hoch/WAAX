...
WX.Noise.prototype=Object.create(WX._Unit.prototype,{type:{enumerable:!0,get:function(){return this._type},set:function(a){this._type=a}}});WX.Sampler=function(a){WX._Unit.call(this);Object.defineProperties(this,{_buffer:{enumerable:!1,writable:!0,value:void 0},_node:{enumerable:!1,writable:!0,value:void 0},_url:{enumerable:!1,writable:!0,value:""},_basePitch:{enumerable:!1,writable:!0,value:60},_label:{enumerable:!1,writable:!1,value:WX._Dictionary.Sampler},_ready:{enumerable:!1,writable:!0,value:!1}});this.params=a};
WX.Sampler.prototype=Object.create(WX._Unit.prototype,{source:{enumerable:!0,get:function(){return this._url},set:function(a){if(void 0===a)return WX.error(this,"invalid audio file path."),!1;var b=this,c=new XMLHttpRequest;c.open("GET",a,!0);c.responseType="arraybuffer";c.onload=function(){try{b._buffer=WX._context.createBuffer(c.response,!0),b._ready=!0}catch(e){WX.error(b,"file loading error: "+a+" ("+e.message+")")}};c.send();this._url=a;return!0}},basePitch:{enumerable:!0,get:function(){return this._basePitch},
set:function(a){this._basePitch=a}},noteOn:{value:function(a){this._ready?(this._node=WX._context.createBufferSource(),this._node.buffer=this._buffer,this._node.connect(this._outlet),void 0!==a&&(a=Math.pow(2,(a-this._basePitch)/12),this._node.playbackRate.setValueAtTime(a,0)),this._node.start(0)):WX.error(this,"sampler is not ready.")}},noteOff:{value:function(){this._node&&this._node.stop(0)}}});WX.LFO=function(a){WX._Unit.call(this);Object.defineProperties(this,{_lfo:{enumerable:!1,writable:!1,value:WX._context.createOscillator()},_label:{enumerable:!1,writable:!1,value:WX._Dictionary.LFO}});this._lfo.connect(this._outlet);this._lfo.frequency.value=5;this._lfo.noteOn(0);this.params=a};
WX.LFO.prototype=Object.create(WX._Unit.prototype,{rate:{enumerable:!0,get:function(){return this._lfo.frequency.value},set:function(a){a=Math.max(0,Math.min(20,a));this._lfo.frequency.value=a}},depth:{enumerable:!0,get:function(){return this._outlet.gain.value},set:function(a){this._outlet.gain.value=a}},shape:{enumerable:!0,get:function(){return this._lfo.type},set:function(a){this._lfo.type=a}}});WX.ADSR=function(a){WX._Unit.call(this);Object.defineProperties(this,{_a:{enumerable:!1,writable:!0,value:0.0050},_d:{enumerable:!1,writable:!0,value:0.015},_s:{enumerable:!1,writable:!0,value:0.35},_r:{enumerable:!1,writable:!0,value:0.015},_running:{enumerable:!1,writable:!0,value:!1},_label:{enumerable:!1,writable:!1,value:WX._Dictionary.ADSR}});this._inlet.connect(this._outlet);this._inlet.gain.value=0;this.params=a};
...
set:function(a){this._wet.gain.value=a;this._dry.gain.value=1-a}}});WX.C2=function(a){WX._Unit.call(this);Object.defineProperties(this,{_threshold:{enumerable:!1,writable:!0,value:WX.db2lin(-12)},_ratio:{enumerable:!1,writable:!0,value:4},_iratio:{enumerable:!1,writable:!0,value:1/(this._ratio-1)},_makeup:{enumerable:!1,writable:!0,value:WX.db2lin(0)},_detector:{enumerable:!1,writable:!1,value:new WX._Internals.DualLevelDetector},_processor:{enumerable:!1,writable:!1,value:WX._context.createScriptProcessor(WX._customUnitBufferSize,2,2)}});var b=this;this._processor.onaudioprocess=
function(a){b._callback(a)};this._inlet.connect(this._processor);this._processor.connect(this._outlet);this.params=a};
WX.C2.prototype=Object.create(WX._Unit.prototype,{_callback:{value:function(a){var b,c=a.inputBuffer.getChannelData(0),e=a.inputBuffer.getChannelData(1),f=a.outputBuffer.getChannelData(0);a=a.outputBuffer.getChannelData(1);for(var d=0,g=WX._customUnitBufferSize;d<g;++d)b=Math.max(Math.abs(c[d]),Math.abs(e[d])),b=this._detector.process(b),b=WX.lin2db(b/this._threshold),b=0>=b?0:b*this._iratio,b=WX.db2lin(b),f[d]=c[d]*b*this._makeup,a[d]=e[d]*b*this._makeup}},threshold:{enumerable:!0,get:function(){return WX.lin2db(this._threshold)},
set:function(a){this._threshold=WX.db2lin(a)}},ratio:{enumerable:!0,get:function(){return this._ratio},set:function(a){this._ratio=a;this._iratio=1/(this._ratio-1)}},attack:{enumerable:!0,get:function(){return this._detector.attack},set:function(a){this._detector.attack=a}},release:{enumerable:!0,get:function(){return this._detector.release},set:function(a){this._detector.release=a}},makeup:{enumerable:!0,get:function(){return WX.lin2db(this._makeup)},set:function(a){this._makeup=WX.db2lin(a)}}});
