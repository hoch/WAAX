...
WX._unit.itrain.prototype={label:"itrain",_default:{gain:1},freq:function(a){return a?(this._frequency=0.1>a?0.1:a,this._impulse.loopEnd=1/this._frequency,this):this._frequency},stop:function(a){this._impulse.stop(a||WX.now)}};WX._unit.extend(WX._unit.itrain.prototype,WX._unit.generator.prototype);WX._unit.itrain2=function(a){WX._unit.generator.call(this);this._impulse=WX.context.createOscillator();this._impulse.connect(this._outputGain);this._impulse.setWaveTable(WX._builtin.impulseWavelet);this._impulse.start(0);WX._unit.bindAudioParam.call(this,"freq",this._impulse.frequency);WX._unit.bindAudioParam.call(this,"detune",this._impulse.detune);this._initializeParams(a,this._default)};
WX._unit.itrain2.prototype={label:"itrain2",_default:{freq:1,gain:1},stop:function(a){this._impulse.stop(a||WX.now)}};WX._unit.extend(WX._unit.itrain2.prototype,WX._unit.generator.prototype);WX._unit.sampler=function(a){WX._unit.generator.call(this);this._player=this._buffer=null;this._basePitch=60;this._ready=!1;this._url=null;this._loop=!1;var b=this;this._oncomplete=function(a){b._url=a.url;b._buffer=a.buffer;b._ready=a.status};this._initializeParams(a,this._default)};
WX._unit.sampler.prototype={label:"sampler",_default:{basePitch:60,loop:!1},source:function(a){if(a)WX._loadBuffer(a,this._oncomplete);else return this._url},basePitch:function(a){if(a)this._basePitch=a;else return this._basePitch},loop:function(a){this._loop=a},start:function(a,b){this._player=WX.context.createBufferSource();this._player.buffer=this._buffer;this._loop&&(this._player.loop=1);this._player.connect(this._outputGain);if(void 0!==a){var c=Math.pow(2,(a-this._basePitch)/12);this._player.playbackRate.setValueAtTime(c,
b||WX.now)}this._player.start(b||WX.now);return this},stop:function(a){this._player&&this._player.stop(a||WX.now)}};WX._unit.extend(WX._unit.sampler.prototype,WX._unit.generator.prototype);WX._unit.step=function(a){WX._unit.generator.call(this);this._step=WX.context.createBufferSource();this._step.buffer=WX._builtin.step;this._step.loop=1;this._step.loopEnd=1;this._step.connect(this._outputGain);this._step.start(0);this._initializeParams(a,this._default)};WX._unit.step.prototype={label:"step",_default:{gain:1},stop:function(a){this._step.stop(a||WX.now)}};WX._unit.extend(WX._unit.step.prototype,WX._unit.generator.prototype);WX._unit.fader=function(a){WX._unit.processor.call(this);this._inverter=WX.context.createGain();this._left=WX.context.createGain();this._right=WX.context.createGain();this._merger=WX.context.createChannelMerger();this._inputGain.connect(this._inverter);this._inverter.connect(this._left);this._inverter.connect(this._right);this._left.connect(this._merger,0,0);this._right.connect(this._merger,0,1);this._merger.connect(this._outputGain);this._position=0;WX._unit.bindAudioParam.call(this,"inputGain",
...
"dry",this._dry.gain);WX._unit.bindAudioParam.call(this,"wet",this._wet.gain);this._initializeParams(a,this._default)};WX._unit.converb.prototype={label:"converb",_default:{source:"../data/ir/hall.wav",mix:0.1},source:function(a){if(a)WX._loadBuffer(a,this._oncomplete);else return this._url},mix:function(a,b,c){return void 0!==a?(this.dry(1-a,b,c),this.wet(a,b,c)):this.wet()}};WX._unit.extend(WX._unit.converb.prototype,WX._unit.processor.prototype);(function(){WX._log.post("waax ("+WX.version+")");WX._log.verbose(!0);WX._unit.factory([{name:"Oscil",ref:WX._unit.oscil},{name:"Fmop",ref:WX._unit.fmop},{name:"Noise",ref:WX._unit.noise},{name:"ITrain",ref:WX._unit.itrain},{name:"ITrain2",ref:WX._unit.itrain2},{name:"Sampler",ref:WX._unit.sampler},{name:"Step",ref:WX._unit.step},{name:"Fader",ref:WX._unit.fader},{name:"ADSR",ref:WX._unit.adsr},{name:"Filter",ref:WX._unit.filter},{name:"Formant",ref:WX._unit.formant},{name:"FormantV",ref:WX._unit.formantv},
{name:"Pingpong",ref:WX._unit.pingpong},{name:"Chorus",ref:WX._unit.chorus},{name:"Phasor",ref:WX._unit.phasor},{name:"Comp",ref:WX._unit.comp},{name:"Converb",ref:WX._unit.converb}]);WX.DAC=WX.Fader();WX.DAC.connect(WX.context.destination);WX._log.info("master fader created. (WX.DAC)")})();
