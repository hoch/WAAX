(function(){function a(a){a&&!a.setTargetValueAtTime&&(a.setTargetValueAtTime=a.setTargetAtTime)}window.hasOwnProperty("AudioContext")&&!window.hasOwnProperty("webkitAudioContext")&&(window.webkitAudioContext=AudioContext,AudioContext.prototype.internal_createGain=AudioContext.prototype.createGain,AudioContext.prototype.createGain=function(){var b=this.internal_createGain();a(b.gain);return b},AudioContext.prototype.internal_createDelay=AudioContext.prototype.createDelay,AudioContext.prototype.createDelay=
function(){var b=this.internal_createDelay();a(b.delayTime);return b},AudioContext.prototype.internal_createBufferSource=AudioContext.prototype.createBufferSource,AudioContext.prototype.createBufferSource=function(){var b=this.internal_createBufferSource();b.noteOn||(b.noteOn=b.start);b.noteOnGrain||(b.noteOnGrain=b.start);b.noteOff||(b.noteOff=b.stop);a(b.playbackRate);return b},AudioContext.prototype.internal_createDynamicsCompressor=AudioContext.prototype.createDynamicsCompressor,AudioContext.prototype.createDynamicsCompressor=
function(){var b=this.internal_createDynamicsCompressor();a(b.threshold);a(b.knee);a(b.ratio);a(b.reduction);a(b.attack);a(b.release);return b},AudioContext.prototype.internal_createBiquadFilter=AudioContext.prototype.createBiquadFilter,AudioContext.prototype.createBiquadFilter=function(){var b=this.internal_createBiquadFilter();a(b.frequency);a(b.detune);a(b.Q);a(b.gain);for(var c="LOWPASS HIGHPASS BANDPASS LOWSHELF HIGHSHELF PEAKING NOTCH ALLPASS".split(" "),d=0;d<c.length;++d){var e=c[d],f=e.toLowerCase();
b.prototype.hasOwnProperty(e)||(b.prototype[e]=f)}return b},AudioContext.prototype.hasOwnProperty("createOscillator")&&(AudioContext.prototype.internal_createOscillator=AudioContext.prototype.createOscillator,AudioContext.prototype.createOscillator=function(){var b=this.internal_createOscillator();b.noteOn||(b.noteOn=b.start);b.noteOff||(b.noteOff=b.stop);a(b.frequency);a(b.detune);for(var c=["SINE","SQUARE","SAWTOOTH","TRIANGLE","CUSTOM"],d=0;d<c.length;++d){var e=c[d],f=e.toLowerCase();b.prototype.hasOwnProperty(e)||
(b.prototype[e]=f)}b.prototype.hasOwnProperty("setWaveTable")||(b.prototype.setWaveTable=b.prototype.setPeriodicTable);return b}),AudioContext.prototype.internal_createPanner=AudioContext.prototype.createPanner,AudioContext.prototype.createPanner=function(){var a=this.internal_createPanner(),c={EQUALPOWER:"equalpower",HRTF:"HRTF",LINEAR_DISTANCE:"linear",INVERSE_DISTANCE:"inverse",EXPONENTIAL_DISTANCE:"exponential"},d;for(d in c){var e=c[d];a.prototype.hasOwnProperty(d)||(a.prototype[d]=e)}return a},
AudioContext.prototype.hasOwnProperty("createGainNode")||(AudioContext.prototype.createGainNode=AudioContext.prototype.createGain),AudioContext.prototype.hasOwnProperty("createDelayNode")||(AudioContext.prototype.createDelayNode=AudioContext.prototype.createDelay),AudioContext.prototype.hasOwnProperty("createJavaScriptNode")||(AudioContext.prototype.createJavaScriptNode=AudioContext.prototype.createScriptProcessor),AudioContext.prototype.hasOwnProperty("createWaveTable")||(AudioContext.prototype.createWaveTable=
AudioContext.prototype.createPeriodicWave))})(window);WX=function(){var a=new AudioContext,b=function(){};return Object.create(null,{context:{enumerable:!0,get:function(){return a},set:b},sampleRate:{enumerable:!0,get:function(){return a.sampleRate},set:b},now:{enumerable:!0,get:function(){return a.currentTime},set:b},version:{enumerable:!0,get:function(){return"r8"},set:b}})}();WX._log=function(){function a(a,b,e){a+=b;e&&e.label&&(a+=" ("+e.label+")");return a}var b=!0;return{verbose:function(a){"boolean"===typeof a&&(b=a)},post:function(b){console.log(a("[wx] ",b))},info:function(c,d){b&&console.log(a("[wx:info] ",c,d))},warn:function(c,d){b&&console.log(a("[wx:warn] ",c,d))},error:function(b,d){throw Error(a("[wx:err] ",b,d));}}}();
