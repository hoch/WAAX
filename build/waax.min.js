...
a?this.feedforwardLeft(a,b,c).feedforwardRight(a,b,c):[this.feedforwardLeft(),this.feedforwardRight()]},blend:function(a,b,c){return void 0!==a?this.blendLeft(a,b,c).blendRight(a,b,c):[this.blendLeft(),this.blendRight()]},mix:function(a,b,c){return void 0!==a?this.dry(1-a,b,c).wet(a,b,c):this.wet()}};WX._unit.extend(WX._unit.chorus.prototype,WX._unit.processor.prototype);WX._unit.phasor=function(a){WX._unit.processor.call(this);var b=WX.context.createChannelSplitter(),c=WX.context.createChannelMerger();this._dry=WX.context.createGain();this._wet=WX.context.createGain();this._maxNotch=12;this._baseFreq=60;this._spacing=2;this._notch=[];for(var d=0;d<this._maxNotch;++d)this._notch[d]=WX.context.createBiquadFilter(),this._notch[d].type="notch",this._notch[d].frequency=this._baseFreq+Math.pow(this._spacing,d);b.connect(this._notch[0],0,0);b.connect(this._notch[1],1,0);
for(d=0;d<this._maxNotch-2;d+=2)this._notch[d].connect(this._notch[d+2]),this._notch[d+1].connect(this._notch[d+3]);this._notch[this._maxNotch-2].connect(c,0,0);this._notch[this._maxNotch-1].connect(c,0,1);c.connect(this._wet);this._lfo=WX.context.createOscillator();this._depthL=WX.context.createGain();this._depthR=WX.context.createGain();this._lfo.type="triangle";this._lfo.start(0);this._lfo.frequency.value=4;this._depthL.gain.value=200;this._depthR.gain.value=-200;this._lfo.connect(this._depthL);
this._lfo.connect(this._depthR);for(c=0;c<this._maxNotch;++c)0===c%2?this._depthL.connect(this._notch[c].frequency):this._depthR.connect(this._notch[c].frequency);this._inputGain.connect(b);this._inputGain.connect(this._dry);this._dry.connect(this._outputGain);this._wet.connect(this._outputGain);WX._unit.bindAudioParam.call(this,"lfoFreq",this._lfo.frequency);WX._unit.bindAudioParam.call(this,"lfoDepthLeft",this._depthL.gain);WX._unit.bindAudioParam.call(this,"lfoDepthRight",this._depthR.gain);WX._unit.bindAudioParam.call(this,
"dry",this._dry.gain);WX._unit.bindAudioParam.call(this,"wet",this._wet.gain);this._initializeParams(a,this._default)};
WX._unit.phasor.prototype={label:"phasor",_default:{mix:0.8},rate:function(a,b,c){return void 0!==a?this.lfoFreq(4*a+2,b,c):this.lfoFreq()},depth:function(a,b,c){return void 0!==a?this.lfoDepthLeft(200*a,b,c).lfoDepthRight(-200*a,b,c):[this.lfoDepthLeft(),this.lfoDepthRight()]},base:function(a,b){this._baseFreq=a;for(var c=0;c<this._maxNotch;++c)this._notch[c].frequency.setTargetAtTime(this._baseFreq+Math.pow(this._spacing,c),b,0.04)},space:function(a,b){this._spacing=a;for(var c=0;c<this._maxNotch;++c)this._notch[c].frequency.setTargetAtTime(this._baseFreq+
Math.pow(this._spacing,c),b,0.04)},mix:function(a,b,c){return void 0!==a?this.dry(1-a,b,c).wet(a,b,c):this.wet()}};WX._unit.extend(WX._unit.phasor.prototype,WX._unit.processor.prototype);WX._unit.comp=function(a){WX._unit.processor.call(this);this._comp=WX.context.createDynamicsCompressor();this._inputGain.connect(this._comp);this._comp.connect(this._outputGain);WX._unit.bindAudioParam.call(this,"inputGain",this._inputGain.gain);WX._unit.bindAudioParam.call(this,"threshold",this._comp.threshold);WX._unit.bindAudioParam.call(this,"knee",this._comp.knee);WX._unit.bindAudioParam.call(this,"ratio",this._comp.ratio);WX._unit.bindAudioParam.call(this,"attack",this._comp.attack);WX._unit.bindAudioParam.call(this,
