...
b){return Math.round(a+Math.random()*(b-a))}},pitch2freq:{value:function(a){return 440*Math.pow(2,(Math.floor(a)-69)/12)}},freq2pitch:{value:function(a){return Math.floor(69+12*Math.log(a/440)/0.6931471805599453)}},lin2db:{value:function(a){return 20*(1E-5<a?Math.log(a)/2.302585092994046:-5)}},db2lin:{value:function(a){return Math.pow(10,a/20)}}});
...
this._autoclear=a},draw:function(){if(!this._pause){this._analyzer.getByteTimeDomainData(this._buffer);var a=this._context2D;this._autoclear&&a.clearRect(0,0,a.canvas.width,a.canvas.height);a.beginPath();a.moveTo(0,(1-this._buffer[0]/255)*this._scaleY);for(var b=1,c=this._buffer.length;b<c;++b)a.lineTo(b*this._unitX,(1-this._buffer[b]/255)*this._scaleY);a.stroke()}}};WX._unit.extend(WX._unit.waveform.prototype,WX._unit.generator.prototype);WX._unit.spectrum=function(a){WX._unit.analyzer.call(this);this._context2D=null;this._buffer=new Uint8Array(this._analyzer.frequencyBinCount);this._pause=!1;this._autoclear=!0;this._initializeParams(a,this._default)};
WX._unit.spectrum.prototype={label:"spectrum",_default:{},_updateSize:function(){this._unitX=this._context2D.canvas.width/this._buffer.length;this._scaleY=this._context2D.canvas.height},context:function(a){if(void 0===a)return this._context2D;"CanvasRenderingContext2D"!==a.constructor.name?WX.error(this,"invalid drawing context."):(this._context2D=a,this._updateSize())},pause:function(a){if("undefined"===typeof a)return this._pause;this._pause=a},autoClear:function(a){if("undefined"===typeof a)return this._autoclear;
this._autoclear=a},draw:function(){if(!this._pause){this._analyzer.getByteFrequencyData(this._buffer);var a=this._context2D;this._autoclear&&a.clearRect(0,0,a.canvas.width,a.canvas.height);a.beginPath();a.moveTo(0,(1-this._buffer[0]/255)*this._scaleY);for(var b=1,c=this._buffer.length;b<c;++b)a.moveTo(b*this._unitX,1*this._scaleY),a.lineTo(b*this._unitX,(1-this._buffer[b]/255)*this._scaleY);a.stroke()}}};WX._unit.extend(WX._unit.spectrum.prototype,WX._unit.generator.prototype);WX.streamer=function(a){this._initialize(a)};
WX.streamer.prototype={_initialize:function(a){this._verbose=this._status=!1;this.onPitchWheel=this.onAfterTouch=this.onControlChange=this.onNoteOff=this.onNoteOn=this._input=null;this._getInput(a)},_setStatus:function(a){this._status=a},_mapInput:function(a){this._input=a;var b=this;this._input.onmidimessage=function(a){a=a.data;switch(a[0]>>4){case 9:if(b.onNoteOn)b.onNoteOn(a[1],a[2]);break;case 8:if(b.onNoteOff)b.onNoteOff(a[1],a[2]);break;case 11:if(b.onControlChange)b.onControlChange(a[1],a[2]);
break;case 13:if(b.onAfterTouch)b.onAfterTouch(a[1]);break;case 14:if(b.onPitchWheel)b.onPitchWheel(a[1]*a[2])}};this._setStatus(!0)},_getInput:function(a){if("undefined"===typeof navigator.requestMIDIAccess)return WX._log.error("your browser does not support Web MIDI API. halt."),null;var b=this;navigator.requestMIDIAccess().then(function(c){if(a>=c.inputs().length)return WX._log.error("invalid port index. max = "+c.inputs().length),null;c=c.inputs();b._mapInput(c[a]);if(b.verbose){var d=0;console.log("# STAT PORTS: ("+
c[d].manufacturer+")");c.map(function(a){console.log(a.type,d++,"\t",a.name,"\t")})}},function(a){WX._log.error("failed to get MIDI access: "+a)})}};(function(){WX._log.info("building unit factory...");WX._unit.factory([{name:"Oscil",ref:WX._unit.oscil},{name:"Fmop",ref:WX._unit.fmop},{name:"Noise",ref:WX._unit.noise},{name:"ITrain",ref:WX._unit.itrain},{name:"Sampler",ref:WX._unit.sampler},{name:"Step",ref:WX._unit.step},{name:"Fader",ref:WX._unit.fader},{name:"Spatter",ref:WX._unit.spatter},{name:"ADSR",ref:WX._unit.adsr},{name:"Filter",ref:WX._unit.filter},{name:"Formant",ref:WX._unit.formant},{name:"FormantV",ref:WX._unit.formantv},{name:"Pingpong",
ref:WX._unit.pingpong},{name:"Chorus",ref:WX._unit.chorus},{name:"Phasor",ref:WX._unit.phasor},{name:"Comp",ref:WX._unit.comp},{name:"Converb",ref:WX._unit.converb},{name:"Waveform",ref:WX._unit.waveform},{name:"Spectrum",ref:WX._unit.spectrum},{name:"Streamer",ref:WX.streamer}]);WX.DAC=WX.Fader();WX.DAC.connect(WX.context.destination);WX._log.info("master fader created. (WX.DAC)");WX._log.post("waax ("+WX.version+") is ready.");WX._log.verbose(!1)})();
