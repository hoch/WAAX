function Control (targetView, name, unit, defaultValue, minValue, maxValue, useLogScale) {
    ...
    this.setNormValue = function (normValue) {
        this.normValue = normValue;
        this.value = this.normValue * (this.maxValue - this.minValue) + this.minValue;
        this.updateView();
    }
    ...
    this._initTargetView = function () {
        this.targetView.controller = this;
        this.targetView.setName(this.getName());
        this.targetView.setUnit(this.getUnit());
        this.targetView.setValue(this.getValue());
        this.targetView.setSliderPosition(this.getNormValue());
...
function SliderView (UIContainerID, precision) {
    ...
    this.setValue = function (value) {
        this.valueDiv.textContent = value.toFixed(this.precision);
    }
    ...
    this.initialize = function () {
        ...
        this.viewDiv.onmousedown = function (e) {
            if (e.altKey) {
                this.toggleMIDILearn();
            }
        }.bind(this);
