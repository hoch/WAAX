...
(function (WX) {
  ...
  FMKey7.prototype = {
    ...
    noteOn: function (pitch, velocity, time) {
      time = (time || WX.now);
      var voice = new FMKey7Voice(this);
  ...
  WX.PlugIn.extendPrototype(FMKey7, 'Generator');

  // REQUIRED: registering plug-in into WX ecosystem
  WX.PlugIn.register(FMKey7);
