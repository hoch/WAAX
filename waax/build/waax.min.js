!function(){var _audioContextFlagWebKit=window.hasOwnProperty("webkitAudioContext"),_audioContextFlagNonPrefixed=window.hasOwnProperty("AudioContext");if(!_audioContextFlagWebKit&&!_audioContextFlagNonPrefixed)throw new Error("FATAL: Web Audio API is not supported on your browser.");_audioContextFlagWebKit&&!_audioContextFlagNonPrefixed&&(window.AudioContext=window.webkitAudioContext)}(),window.WX={_VERSION:"1.0.0-alpha3"},WX.WAVEFORMS=[{key:"Sine",value:"sine"},{key:"Square",value:"square"},{key:"Sawtooth",value:"sawtooth"},{key:"Triangle",value:"triangle"}],WX.FILTER_TYPES=[{key:"LP",value:"lowpass"},{key:"HP",value:"highpass"},{key:"BP",value:"bandpass"},{key:"LS",value:"lowshelf"},{key:"HS",value:"highshelf"},{key:"PK",value:"peaking"},{key:"BR",value:"notch"},{key:"AP",value:"allpass"}],WX._ctx=new AudioContext;
Object.defineProperties(WX,{now:{get:function(){return WX._ctx.currentTime}},srate:{get:function(){return WX._ctx.sampleRate}}}),WX.Gain=function(){return WX._ctx.createGain()},WX.OSC=function(){return WX._ctx.createOscillator()},WX.Delay=function(){return WX._ctx.createDelay()},WX.Filter=function(){return WX._ctx.createBiquadFilter()},WX.Comp=function(){return WX._ctx.createDynamicsCompressor()},WX.Convolver=function(){return WX._ctx.createConvolver()},WX.WaveShaper=function(){return WX._ctx.createWaveShaper()},WX.Source=function(){return WX._ctx.createBufferSource()},WX.Analyzer=function(){return WX._ctx.createAnalyser()},WX.Panner=function(){return WX._ctx.createPanner()},WX.PeriodicWave=function(){return WX._ctx.createPeriodicWave.apply(WX._ctx,arguments)},WX.Splitter=function(){return WX._ctx.createChannelSplitter.apply(WX._ctx,arguments)},WX.Merger=function(){return WX._ctx.createChannelMerger.apply(WX._ctx,arguments)},WX.Buffer=function(){return WX._ctx.createBuffer.apply(WX._ctx,arguments)},AudioNode.prototype.to=function(){for(var i=0;i<arguments.length;i++)this.connect(arguments[i]);return arguments[0]},AudioNode.prototype.cut=function(){this.disconnect()},AudioParam.prototype.cancel=AudioParam.prototype.cancelScheduledValues,AudioParam.prototype.set=function(value,time,rampType){var now=WX.now;switch(rampType){case 0:case void 0:time=now>time?now:time,this.setValueAtTime(value,time),now>=time&&value!==this.value&&(this.value=value);break;case 1:time=now>time?now:time,this.linearRampToValueAtTime(value,time);break;case 2:time=now>time?now:time,value=0>=value?1e-5:value,this.exponentialRampToValueAtTime(value,time);break;case 3:time[0]=time[0]<now?now:time[0],value=0>=value?1e-5:value,this.setTargetAtTime(value,time[0],time[1])}};
...
!function(WX){function Fader(preset){WX.PlugIn.defineType(this,"Processor"),this._input.to(this._output),WX.defineParams(this,{output:{type:"Generic",name:"Output","default":1,min:0,max:3.9810717055349722,unit:"LinearGain"},mute:{type:"Boolean",name:"Mute","default":!1},pan:{type:"Generic",name:"Pan","default":0,min:-1,max:1},dB:{type:"Generic",name:"dB","default":0,min:-60,max:12,unit:"Decibels"}}),WX.PlugIn.initPreset(this,preset)}Fader.prototype={info:{name:"Fader",version:"0.0.2",api_version:"1.0.0-alpha",author:"Hongchan Choi",type:"Processor",description:"Channel Fader"},defaultPreset:{mute:!1,pan:0,dB:0},$mute:function(value){value?this._outlet.gain.set(0,WX.now,0):this._outlet.gain.set(1,WX.now,0)},$pan:function(){},$dB:function(value,time,rampType){this.params.output.set(WX.dbtolin(value),time,rampType)}},WX.PlugIn.extendPrototype(Fader,"Processor"),WX.PlugIn.register(Fader),WX.Master=WX.Fader(),WX.Master.to(WX._ctx.destination)}(WX);
